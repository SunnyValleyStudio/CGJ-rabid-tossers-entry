                            ...
                            )
                        {
                            ...
                            if (lastPrediction.magnitude > 0.01f)
                            {
                                if (followingGuard != null)
                                {
                                    ...
                                    fightingSheep = false;
                                    currentlyAttackedUnit = followingGuard;
                                    StartAFight();
                                }
                                else
                                {
                                    sheepFollowing.GetComponent<FlockAgent3dSVS>().EnableBlood();
                                    fightingSheep = true;
                                    currentlyAttackedUnit = sheepFollowing.GetComponent<FlockAgent3dSVS>();
                                    StartAFight();
                                }
                            }
                        }
