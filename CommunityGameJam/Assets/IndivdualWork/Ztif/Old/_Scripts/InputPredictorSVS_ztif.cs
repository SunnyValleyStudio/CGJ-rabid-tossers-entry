...
{
public class InputPredictorSVS_ztif : MonoBehaviour
{
private bool _sequenceReady = false;
public bool SequenceReady {
        get => _sequenceReady; private set => _sequenceReady = value;
}
...
{
        var listOfInputsToConsider = new List<Vector3> {
                inputExample, -inputExample, inputExample, -inputExample, inputExample, -inputExample, inputExample, -inputExample, inputExample, -inputExample,
        };
